...
ironprose compare --original-file draft_v1.md --revised-file draft_v2.md --output json
```
...
ironprose rate --json '{"rule":"repetition","rating":"false_positive","diagnostic_id":"d-001","context":"Intentional repetition"}'

# Convenience flags — for humans or simple ratings
ironprose rate --rule repetition --rating not_helpful --diagnostic-id d-001
```
